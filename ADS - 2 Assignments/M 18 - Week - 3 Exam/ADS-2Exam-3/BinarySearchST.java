...
public class BinarySearchST<Key extends Comparable<Key>, Value> {
     ...
     * the given key in this symbol table.
     *
     * @param  key the key
    ...
    /**
     * Returns the smallest key in this symbol
     ...
     * To iterate over all of the keys in
     * the symbol table named {@code st},
     ...
     * @param lo minimum endpoint
     * @param hi maximum endpoint
     * @return all keys in this symbol
